    ...
    return (
        <div className={styles.container}>
          ...
          <div className={styles.logoContainer}>
            <Image
              src="/images/Proyect/paypal2.png"
              alt="Paypal"
              width={40}
              height={40}
        ...
        <div className={styles.paymentOption}>
          ...
          <div className={styles.cardLogosContainer}>
            <Image
              src="/images/Proyect/icovisa.png"
              alt="Visa"
              width={32}
              height={32}
            ...
            />
            <Image
              src="/images/Proyect/icoamerica.png"
            ...
            />
            <Image
              src="/images/Proyect/icomaster.png"
              alt="Mastercard"
              width={32}
              height={32}
              className={styles.cardLogo}
        ...
        <div className={styles.paymentOption}>
          ...
          <div className={styles.logoContainer}>
            <Image
              src="/images/Proyect/icobinance.png"
              alt="Binance"
              width={40}
              height={40}
